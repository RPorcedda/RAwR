...
def random_rawr_splits(data, val_ratio=0.05, test_ratio=0.1, seed=None, use_seed=False):
    """
    Node split used in EPR/RAwR:
    - test: int(test_ratio * N)
    - val : int(val_ratio  * N)
    - train: remaining nodes
    """
