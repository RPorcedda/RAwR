...
from torch_geometric.nn import GATConv, GCNConv, ChebConv, GINConv
...
class GIN_Net(nn.Module):
    def __init__(self, dataset, args):
        ...
        self.dropout = args.dropout
        self.num_layers = max(2, args.num_layers)
        ...
        for layer_idx in range(self.num_layers - 1):
            layer_in = in_dim if layer_idx == 0 else hidden
            mlp = nn.Sequential(
        ...
        self.convs.append(GINConv(out_mlp))
